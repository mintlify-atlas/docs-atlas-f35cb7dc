...
<Tabs>
  <Tab title="Dark Mode (Cyber)">
    **Default Theme**
    
    - Modern dark interface with cyberpunk aesthetics
    - Elegant gradient effects and animations
    - Optimized for low-light environments
    - Reduced eye strain during extended sessions
    
    **Best For**: Night work, extended coding sessions, modern aesthetic preference
  </Tab>
  ...
  <Tab title="Pixel Art">
    **Retro Style** (Legacy)
    ...
    - Nostalgic 8-bit inspired design
    - Animated pixel elements
    - Unique visual character
    
    **Best For**: Creative work, retro gaming enthusiasts, casual use
  </Tab>
  
  <Tab title="Hacker">
    **Terminal Style** (Legacy)
    ...
    **Best For**: Developers, terminal enthusiasts, cybersecurity professionals
  </Tab>
</Tabs>
...
<Steps>
  ...
  <Step title="Select Theme">
    ...
    - 🌙 **Dark (Cyber)** - Modern dark theme with gradients
